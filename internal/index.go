...
func Summarize(ctx context.Context, c genai.Provider, content string) (string, error) {
...
func ProcessHTML(ctx context.Context, c genai.Provider, r io.Reader, mdPath string) (string, string, error) {
